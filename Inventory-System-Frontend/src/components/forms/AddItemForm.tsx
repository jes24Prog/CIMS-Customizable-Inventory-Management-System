...
import type { AddItemFormProps, Category } from '@/types';
...
export default function AddItemForm({ open, onOpenChange, onSuccess }: AddItemFormProps) {
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="60 x 40 x 80 cm" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="5.5 kg" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
